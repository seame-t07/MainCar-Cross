...
class IVehicleMotionManagementElectricAxleRow2Subscriber;
class IVehicleMotionManagementElectricAxleRow2Publisher;

/**
*
* IVehicleMotionManagementElectricAxleRow2 provides an interface for
 *  - methods defined for your Vehicle_MotionManagement_ElectricAxle_Row2 
 *  - property setters and getters for defined properties
 * The IVehicleMotionManagementElectricAxleRow2 also provides an interface to access a publisher IVehicleMotionManagementElectricAxleRow2Publisher, a class used by IVehicleMotionManagementElectricAxleRow2Subscriber clients.
 * The implementation should notify the publisher IVehicleMotionManagementElectricAxleRow2Publisher about emitted signals or state changed. 
 * The publisher responsibility is to keep its clients informed about requested changes.
 * See also IVehicleMotionManagementElectricAxleRow2Subscriber, IVehicleMotionManagementElectricAxleRow2Publisher
 * and the example implementation Vehicle_MotionManagement_ElectricAxle_Row2  or the
 */
class CPP_VEHICLE_EXPORT IVehicleMotionManagementElectricAxleRow2
{
public:
    virtual ~IVehicleMotionManagementElectricAxleRow2() = default;
    ...
    */
    virtual IVehicleMotionManagementElectricAxleRow2Publisher& _getPublisher() const = 0;
};


/**
 * The IVehicleMotionManagementElectricAxleRow2Subscriber contains functions to allow informing about signals or property changes of the IVehicleMotionManagementElectricAxleRow2 implementation.
 * The implementation for IVehicleMotionManagementElectricAxleRow2 should provide mechanism for subscription of the IVehicleMotionManagementElectricAxleRow2Subscriber clients.
 * See IVehicleMotionManagementElectricAxleRow2Publisher, which provides facilitation for this purpose.
 * The implementation for IVehicleMotionManagementElectricAxleRow2 should call the IVehicleMotionManagementElectricAxleRow2Subscriber interface functions on either signal emit or property change.
 * You can use IVehicleMotionManagementElectricAxleRow2Subscriber class to implement clients of the IVehicleMotionManagementElectricAxleRow2 or the network adapter - see Olink Server and Client example.
 */
class CPP_VEHICLE_EXPORT IVehicleMotionManagementElectricAxleRow2Subscriber
{
public:
    virtual ~IVehicleMotionManagementElectricAxleRow2Subscriber() = default;
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when Torque value has changed if subscribed for the Torque change.
    * @param Torque Axle torque, positive sign for torque in forward direction, negative sign for torque in backward direction.
    *
    ...
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueTarget value has changed if subscribed for the TorqueTarget change.
    * @param TorqueTarget Target axle torque in torque control mode, positive sign for torque in forward direction, negative sign for torque in backward direction (ISO8855).
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueMaximum value has changed if subscribed for the TorqueMaximum change.
    * @param TorqueMaximum Maximum momentarily available eAxle torque, positive sign for torque in forward direction, negative sign for torque in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueMinimum value has changed if subscribed for the TorqueMinimum change.
    * @param TorqueMinimum Minimum momentarily available eAxle torque, positive sign for torque in forward direction, negative sign for torque in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueLongTermMaximum value has changed if subscribed for the TorqueLongTermMaximum change.
    * @param TorqueLongTermMaximum Maximum long-term available eAxle torque, default time horizon = 10 sec, positive sign for torque in forward direction, negative sign for torque in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueLongTermMinimum value has changed if subscribed for the TorqueLongTermMinimum change.
    * @param TorqueLongTermMinimum Minimum long-term available eAxle torque, default time horizon = 10 sec, positive sign for torque in forward direction, negative sign for torque in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueShortTermMaximum value has changed if subscribed for the TorqueShortTermMaximum change.
    * @param TorqueShortTermMaximum Maximum short-term available eAxle torque, default time horizon = 1 sec, positive sign for torque in forward direction, negative sign for torque in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueShortTermMinimum value has changed if subscribed for the TorqueShortTermMinimum change.
    * @param TorqueShortTermMinimum Minimum short-term available eAxle torque, default time horizon = 1 sec, positive sign for torque in forward direction, negative sign for torque in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueMaximumLimit value has changed if subscribed for the TorqueMaximumLimit change.
    * @param TorqueMaximumLimit Maximum allowed eAxle torque in rotation speed control mode, positive sign for torque in forward direction, negative sign unused.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when TorqueMinimumLimit value has changed if subscribed for the TorqueMinimumLimit change.
    * @param TorqueMinimumLimit Minimum allowed axle torque in rotation speed control mode, positive sign unused, negative sign for torque in backward direction (ISO8855).
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when RotationalSpeed value has changed if subscribed for the RotationalSpeed change.
    * @param RotationalSpeed Rotational speed for the specified axle, positive sign for rotation in forward direction, negative sign for rotation in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when RotationalSpeedTarget value has changed if subscribed for the RotationalSpeedTarget change.
    * @param RotationalSpeedTarget Target axle rotational speed in rotation speed control mode, positive sign for rotation in forward direction, negative sign for rotation in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when RotationalSpeedMaximumLimit value has changed if subscribed for the RotationalSpeedMaximumLimit change.
    * @param RotationalSpeedMaximumLimit Maximum allowed axle rotational speed in torque control mode, positive sign for rotation in forward direction, negative sign for rotation in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    ...
    /**
    * Called by the IVehicleMotionManagementElectricAxleRow2Publisher when RotationalSpeedMinimumLimit value has changed if subscribed for the RotationalSpeedMinimumLimit change.
    * @param RotationalSpeedMinimumLimit Minimum allowed axle rotational speed in torque control mode, positive sign for rotation in forward direction, negative sign for rotation in backward direction.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
...
using VehicleMotionManagementElectricAxleRow2TorquePropertyCb = std::function<void(int32_t Torque)>;
/** Callback for changes of TorqueTarget */
using VehicleMotionManagementElectricAxleRow2TorqueTargetPropertyCb = std::function<void(int32_t TorqueTarget)>;
/** Callback for changes of TorqueMaximum */
using VehicleMotionManagementElectricAxleRow2TorqueMaximumPropertyCb = std::function<void(int32_t TorqueMaximum)>;
/** Callback for changes of TorqueMinimum */
using VehicleMotionManagementElectricAxleRow2TorqueMinimumPropertyCb = std::function<void(int32_t TorqueMinimum)>;
/** Callback for changes of TorqueLongTermMaximum */
using VehicleMotionManagementElectricAxleRow2TorqueLongTermMaximumPropertyCb = std::function<void(int32_t TorqueLongTermMaximum)>;
/** Callback for changes of TorqueLongTermMinimum */
using VehicleMotionManagementElectricAxleRow2TorqueLongTermMinimumPropertyCb = std::function<void(int32_t TorqueLongTermMinimum)>;
/** Callback for changes of TorqueShortTermMaximum */
using VehicleMotionManagementElectricAxleRow2TorqueShortTermMaximumPropertyCb = std::function<void(int32_t TorqueShortTermMaximum)>;
/** Callback for changes of TorqueShortTermMinimum */
using VehicleMotionManagementElectricAxleRow2TorqueShortTermMinimumPropertyCb = std::function<void(int32_t TorqueShortTermMinimum)>;
/** Callback for changes of TorqueMaximumLimit */
using VehicleMotionManagementElectricAxleRow2TorqueMaximumLimitPropertyCb = std::function<void(int32_t TorqueMaximumLimit)>;
/** Callback for changes of TorqueMinimumLimit */
using VehicleMotionManagementElectricAxleRow2TorqueMinimumLimitPropertyCb = std::function<void(int32_t TorqueMinimumLimit)>;
/** Callback for changes of RotationalSpeed */
using VehicleMotionManagementElectricAxleRow2RotationalSpeedPropertyCb = std::function<void(int32_t RotationalSpeed)>;
/** Callback for changes of RotationalSpeedTarget */
using VehicleMotionManagementElectricAxleRow2RotationalSpeedTargetPropertyCb = std::function<void(int32_t RotationalSpeedTarget)>;
/** Callback for changes of RotationalSpeedMaximumLimit */
using VehicleMotionManagementElectricAxleRow2RotationalSpeedMaximumLimitPropertyCb = std::function<void(int32_t RotationalSpeedMaximumLimit)>;
/** Callback for changes of RotationalSpeedMinimumLimit */
using VehicleMotionManagementElectricAxleRow2RotationalSpeedMinimumLimitPropertyCb = std::function<void(int32_t RotationalSpeedMinimumLimit)>;


/**
 * The IVehicleMotionManagementElectricAxleRow2Publisher provides an api for clients to subscribe to or unsubscribe from a signal emission 
 * or a property change.
 * Implement this interface to keep track of clients of your IVehicleMotionManagementElectricAxleRow2 implementation.
 * The publisher provides two independent methods of subscription
 *  - subscribing with a IVehicleMotionManagementElectricAxleRow2Subscriber objects - for all of the changes
 *  - subscribing any object for single type of change property or a signal
 * The publish functions needs to be called by implementation of the IIVehicleMotionManagementElectricAxleRow2 on each state changed or signal emitted
 * to notify all the subscribers about this change.
 */
class CPP_VEHICLE_EXPORT IVehicleMotionManagementElectricAxleRow2Publisher
{
public:
    virtual ~IVehicleMotionManagementElectricAxleRow2Publisher() = default;

    /**
    * Use this function to subscribe for any change of the Vehicle_MotionManagement_ElectricAxle_Row2.
    * Subscriber will be informed of any emitted signal and any property changes.
    * This is parallel notification system to single subscription. If you will subscribe also for a single change
    * your subscriber will be informed twice about that change, one for each subscription mechanism.
    * @param IVehicleMotionManagementElectricAxleRow2Subscriber which is subscribed in this function to any change of the Vehicle_MotionManagement_ElectricAxle_Row2.
    */
    virtual void subscribeToAllChanges(IVehicleMotionManagementElectricAxleRow2Subscriber& subscriber) = 0;
    /**
    * Use this function to remove subscription to all of the changes of the Vehicle_MotionManagement_ElectricAxle_Row2.
    * Not all subscriptions will be removed, the ones made separately for single signal or property change stay intact.
    * Make sure to remove them.
    * @param IVehicleMotionManagementElectricAxleRow2Subscriber which subscription for any change of the Vehicle_MotionManagement_ElectricAxle_Row2 is removed.
    */
    virtual void unsubscribeFromAllChanges(IVehicleMotionManagementElectricAxleRow2Subscriber& subscriber) = 0;

    /**
    * Use this function to subscribe for Torque value changes.
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorquePropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueChanged(VehicleMotionManagementElectricAxleRow2TorquePropertyCb callback) = 0;
    /**
    * Use this function to unsubscribe from Torque property changes.
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will be still informed about this change,
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueTargetPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueTargetChanged(VehicleMotionManagementElectricAxleRow2TorqueTargetPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueMaximumPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueMaximumChanged(VehicleMotionManagementElectricAxleRow2TorqueMaximumPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueMinimumPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueMinimumChanged(VehicleMotionManagementElectricAxleRow2TorqueMinimumPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueLongTermMaximumPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueLongTermMaximumChanged(VehicleMotionManagementElectricAxleRow2TorqueLongTermMaximumPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueLongTermMinimumPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueLongTermMinimumChanged(VehicleMotionManagementElectricAxleRow2TorqueLongTermMinimumPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueShortTermMaximumPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueShortTermMaximumChanged(VehicleMotionManagementElectricAxleRow2TorqueShortTermMaximumPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueShortTermMinimumPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueShortTermMinimumChanged(VehicleMotionManagementElectricAxleRow2TorqueShortTermMinimumPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueMaximumLimitPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueMaximumLimitChanged(VehicleMotionManagementElectricAxleRow2TorqueMaximumLimitPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2TorqueMinimumLimitPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToTorqueMinimumLimitChanged(VehicleMotionManagementElectricAxleRow2TorqueMinimumLimitPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2RotationalSpeedPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToRotationalSpeedChanged(VehicleMotionManagementElectricAxleRow2RotationalSpeedPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2RotationalSpeedTargetPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToRotationalSpeedTargetChanged(VehicleMotionManagementElectricAxleRow2RotationalSpeedTargetPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2RotationalSpeedMaximumLimitPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToRotationalSpeedMaximumLimitChanged(VehicleMotionManagementElectricAxleRow2RotationalSpeedMaximumLimitPropertyCb callback) = 0;
    /**
    ...
    * If your subscriber uses subscription with IVehicleMotionManagementElectricAxleRow2Subscriber interface, you will get two notifications, one for each subscription mechanism.
    * @param VehicleMotionManagementElectricAxleRow2RotationalSpeedMinimumLimitPropertyCb callback that will be executed on each change of the property.
    * Make sure to remove subscription before the callback becomes invalid.
    * @return subscription token for the subscription removal.
    *
    * @warning the subscribed function shall not be blocking and must return immediately!
    */
    virtual long subscribeToRotationalSpeedMinimumLimitChanged(VehicleMotionManagementElectricAxleRow2RotationalSpeedMinimumLimitPropertyCb callback) = 0;
    /**
    ...
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property Torque changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueTarget changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueMaximum changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueMinimum changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueLongTermMaximum changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueLongTermMinimum changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueShortTermMaximum changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueShortTermMinimum changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueMaximumLimit changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property TorqueMinimumLimit changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property RotationalSpeed changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property RotationalSpeedTarget changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property RotationalSpeedMaximumLimit changes.
    ...
    */
    ...
    /**
    * Publishes the property changed to all subscribed clients.
    * Needs to be invoked by the Vehicle_MotionManagement_ElectricAxle_Row2 implementation when property RotationalSpeedMinimumLimit changes.
