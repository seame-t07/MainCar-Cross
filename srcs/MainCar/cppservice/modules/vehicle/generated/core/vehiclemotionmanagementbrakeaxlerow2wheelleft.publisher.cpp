...
void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::subscribeToAllChanges(IVehicleMotionManagementBrakeAxleRow2WheelLeftSubscriber& subscriber)
{
    ...
    {
        m_allChangesSubscribers.push_back(std::reference_wrapper<IVehicleMotionManagementBrakeAxleRow2WheelLeftSubscriber>(subscriber));
    }
}

void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::unsubscribeFromAllChanges(IVehicleMotionManagementBrakeAxleRow2WheelLeftSubscriber& subscriber)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_allChangesSubscribersMutex);
    auto found = std::find_if(m_allChangesSubscribers.begin(), m_allChangesSubscribers.end(),
                        [&subscriber](const auto element){return &(element.get()) == &subscriber;});
...
long VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::subscribeToTorqueChanged(VehicleMotionManagementBrakeAxleRow2WheelLeftTorquePropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::unsubscribeFromTorqueChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueCallbacksMutex);
    m_torqueCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::publishTorqueChanged(int32_t Torque) const
{
...
long VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::subscribeToTorqueArbitratedChanged(VehicleMotionManagementBrakeAxleRow2WheelLeftTorqueArbitratedPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::unsubscribeFromTorqueArbitratedChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueArbitratedCallbacksMutex);
    m_torqueArbitratedCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::publishTorqueArbitratedChanged(int32_t TorqueArbitrated) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::subscribeToTorqueFrictionMaximumChanged(VehicleMotionManagementBrakeAxleRow2WheelLeftTorqueFrictionMaximumPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::unsubscribeFromTorqueFrictionMaximumChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueFrictionMaximumCallbacksMutex);
    m_torqueFrictionMaximumCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::publishTorqueFrictionMaximumChanged(int32_t TorqueFrictionMaximum) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::subscribeToTorqueFrictionMinimumChanged(VehicleMotionManagementBrakeAxleRow2WheelLeftTorqueFrictionMinimumPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::unsubscribeFromTorqueFrictionMinimumChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueFrictionMinimumCallbacksMutex);
    m_torqueFrictionMinimumCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::publishTorqueFrictionMinimumChanged(int32_t TorqueFrictionMinimum) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::subscribeToOmegaUpperChanged(VehicleMotionManagementBrakeAxleRow2WheelLeftOmegaUpperPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::unsubscribeFromOmegaUpperChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_omegaUpperCallbacksMutex);
    m_omegaUpperCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::publishOmegaUpperChanged(int32_t OmegaUpper) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::subscribeToOmegaLowerChanged(VehicleMotionManagementBrakeAxleRow2WheelLeftOmegaLowerPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::unsubscribeFromOmegaLowerChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_omegaLowerCallbacksMutex);
    m_omegaLowerCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow2WheelLeftPublisher::publishOmegaLowerChanged(int32_t OmegaLower) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
