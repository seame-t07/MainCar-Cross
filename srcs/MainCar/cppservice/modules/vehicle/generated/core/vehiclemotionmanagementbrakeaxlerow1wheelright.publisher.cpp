...
void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::subscribeToAllChanges(IVehicleMotionManagementBrakeAxleRow1WheelRightSubscriber& subscriber)
{
    ...
    {
        m_allChangesSubscribers.push_back(std::reference_wrapper<IVehicleMotionManagementBrakeAxleRow1WheelRightSubscriber>(subscriber));
    }
}

void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::unsubscribeFromAllChanges(IVehicleMotionManagementBrakeAxleRow1WheelRightSubscriber& subscriber)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_allChangesSubscribersMutex);
    auto found = std::find_if(m_allChangesSubscribers.begin(), m_allChangesSubscribers.end(),
                        [&subscriber](const auto element){return &(element.get()) == &subscriber;});
...
long VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::subscribeToTorqueChanged(VehicleMotionManagementBrakeAxleRow1WheelRightTorquePropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::unsubscribeFromTorqueChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueCallbacksMutex);
    m_torqueCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::publishTorqueChanged(int32_t Torque) const
{
...
long VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::subscribeToTorqueArbitratedChanged(VehicleMotionManagementBrakeAxleRow1WheelRightTorqueArbitratedPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::unsubscribeFromTorqueArbitratedChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueArbitratedCallbacksMutex);
    m_torqueArbitratedCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::publishTorqueArbitratedChanged(int32_t TorqueArbitrated) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::subscribeToTorqueFrictionMaximumChanged(VehicleMotionManagementBrakeAxleRow1WheelRightTorqueFrictionMaximumPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::unsubscribeFromTorqueFrictionMaximumChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueFrictionMaximumCallbacksMutex);
    m_torqueFrictionMaximumCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::publishTorqueFrictionMaximumChanged(int32_t TorqueFrictionMaximum) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::subscribeToTorqueFrictionMinimumChanged(VehicleMotionManagementBrakeAxleRow1WheelRightTorqueFrictionMinimumPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::unsubscribeFromTorqueFrictionMinimumChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_torqueFrictionMinimumCallbacksMutex);
    m_torqueFrictionMinimumCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::publishTorqueFrictionMinimumChanged(int32_t TorqueFrictionMinimum) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::subscribeToOmegaUpperChanged(VehicleMotionManagementBrakeAxleRow1WheelRightOmegaUpperPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::unsubscribeFromOmegaUpperChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_omegaUpperCallbacksMutex);
    m_omegaUpperCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::publishOmegaUpperChanged(int32_t OmegaUpper) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
...
long VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::subscribeToOmegaLowerChanged(VehicleMotionManagementBrakeAxleRow1WheelRightOmegaLowerPropertyCb callback)
{
...
void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::unsubscribeFromOmegaLowerChanged(long handleId)
{
    std::unique_lock<std::shared_timed_mutex> lock(m_omegaLowerCallbacksMutex);
    m_omegaLowerCallbacks.erase(handleId);
}

void VehicleMotionManagementBrakeAxleRow1WheelRightPublisher::publishOmegaLowerChanged(int32_t OmegaLower) const
{
    std::shared_lock<std::shared_timed_mutex> allChangesSubscribersLock(m_allChangesSubscribersMutex);
    const auto allChangesSubscribers = m_allChangesSubscribers;
    allChangesSubscribersLock.unlock();
