...
/**
* A helper structure for implementations of Vehicle_MotionManagement_Brake_Axle_Row1. Stores all the properties.
*/
struct VehicleMotionManagementBrakeAxleRow1Data
{
