...
/**
* A helper structure for implementations of Vehicle_MotionManagement_ElectricAxle_Row2. Stores all the properties.
*/
struct VehicleMotionManagementElectricAxleRow2Data
{
    int32_t m_Torque {0};
