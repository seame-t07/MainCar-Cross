...
/**
* The Vehicle_MotionManagement_Brake_Axle_Row1_Wheel_Right implementation.
*/
class CPP_VEHICLE_EXPORT VehicleMotionManagementBrakeAxleRow1WheelRight : public IVehicleMotionManagementBrakeAxleRow1WheelRight
{
public:
    explicit VehicleMotionManagementBrakeAxleRow1WheelRight();
    ~VehicleMotionManagementBrakeAxleRow1WheelRight();
public:
    /**
...
private:
    /** The publisher for the Vehicle_MotionManagement_Brake_Axle_Row1_Wheel_Right. */
    std::unique_ptr<IVehicleMotionManagementBrakeAxleRow1WheelRightPublisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_MotionManagement_Brake_Axle_Row1_Wheel_Right. */
    VehicleMotionManagementBrakeAxleRow1WheelRightData m_data;
};
} // namespace Vehicle
} // namespace Cpp
