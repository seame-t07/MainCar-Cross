...
/**
* The Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_AnyPosition implementation.
*/
class CPP_VEHICLE_EXPORT VehiclePowertrainTractionBatteryChargingChargingPortAnyPosition : public IVehiclePowertrainTractionBatteryChargingChargingPortAnyPosition
{
public:
    explicit VehiclePowertrainTractionBatteryChargingChargingPortAnyPosition();
    ~VehiclePowertrainTractionBatteryChargingChargingPortAnyPosition();
public:
    /**
...
private:
    /** The publisher for the Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_AnyPosition. */
    std::unique_ptr<IVehiclePowertrainTractionBatteryChargingChargingPortAnyPositionPublisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_AnyPosition. */
    VehiclePowertrainTractionBatteryChargingChargingPortAnyPositionData m_data;
};
} // namespace Vehicle
} // namespace Cpp
