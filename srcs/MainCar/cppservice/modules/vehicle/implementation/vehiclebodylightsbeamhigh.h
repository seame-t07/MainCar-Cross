...
/**
* The Vehicle_Body_Lights_Beam_High implementation.
*/
class CPP_VEHICLE_EXPORT VehicleBodyLightsBeamHigh : public IVehicleBodyLightsBeamHigh
{
public:
    explicit VehicleBodyLightsBeamHigh();
...
private:
    /** The publisher for the Vehicle_Body_Lights_Beam_High. */
    std::unique_ptr<IVehicleBodyLightsBeamHighPublisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_Body_Lights_Beam_High. */
    VehicleBodyLightsBeamHighData m_data;
};
} // namespace Vehicle
} // namespace Cpp
