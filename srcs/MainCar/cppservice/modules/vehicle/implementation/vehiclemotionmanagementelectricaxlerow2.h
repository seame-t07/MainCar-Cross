...
/**
* The Vehicle_MotionManagement_ElectricAxle_Row2 implementation.
*/
class CPP_VEHICLE_EXPORT VehicleMotionManagementElectricAxleRow2 : public IVehicleMotionManagementElectricAxleRow2
{
public:
    explicit VehicleMotionManagementElectricAxleRow2();
    ~VehicleMotionManagementElectricAxleRow2();
public:
    /**
...
private:
    /** The publisher for the Vehicle_MotionManagement_ElectricAxle_Row2. */
    std::unique_ptr<IVehicleMotionManagementElectricAxleRow2Publisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_MotionManagement_ElectricAxle_Row2. */
    VehicleMotionManagementElectricAxleRow2Data m_data;
};
} // namespace Vehicle
} // namespace Cpp
