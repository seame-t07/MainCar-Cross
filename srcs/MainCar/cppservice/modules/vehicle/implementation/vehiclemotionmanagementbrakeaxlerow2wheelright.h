...
/**
* The Vehicle_MotionManagement_Brake_Axle_Row2_Wheel_Right implementation.
*/
class CPP_VEHICLE_EXPORT VehicleMotionManagementBrakeAxleRow2WheelRight : public IVehicleMotionManagementBrakeAxleRow2WheelRight
{
public:
    explicit VehicleMotionManagementBrakeAxleRow2WheelRight();
    ~VehicleMotionManagementBrakeAxleRow2WheelRight();
public:
    /**
...
private:
    /** The publisher for the Vehicle_MotionManagement_Brake_Axle_Row2_Wheel_Right. */
    std::unique_ptr<IVehicleMotionManagementBrakeAxleRow2WheelRightPublisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_MotionManagement_Brake_Axle_Row2_Wheel_Right. */
    VehicleMotionManagementBrakeAxleRow2WheelRightData m_data;
};
} // namespace Vehicle
} // namespace Cpp
