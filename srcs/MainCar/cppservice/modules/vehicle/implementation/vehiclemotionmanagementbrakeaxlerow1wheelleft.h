...
/**
* The Vehicle_MotionManagement_Brake_Axle_Row1_Wheel_Left implementation.
*/
class CPP_VEHICLE_EXPORT VehicleMotionManagementBrakeAxleRow1WheelLeft : public IVehicleMotionManagementBrakeAxleRow1WheelLeft
{
public:
    explicit VehicleMotionManagementBrakeAxleRow1WheelLeft();
    ~VehicleMotionManagementBrakeAxleRow1WheelLeft();
public:
    /**
...
private:
    /** The publisher for the Vehicle_MotionManagement_Brake_Axle_Row1_Wheel_Left. */
    std::unique_ptr<IVehicleMotionManagementBrakeAxleRow1WheelLeftPublisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_MotionManagement_Brake_Axle_Row1_Wheel_Left. */
    VehicleMotionManagementBrakeAxleRow1WheelLeftData m_data;
};
} // namespace Vehicle
} // namespace Cpp
