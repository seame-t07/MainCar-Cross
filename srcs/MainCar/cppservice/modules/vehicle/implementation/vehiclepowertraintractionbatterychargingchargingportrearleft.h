...
/**
* The Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_RearLeft implementation.
*/
class CPP_VEHICLE_EXPORT VehiclePowertrainTractionBatteryChargingChargingPortRearLeft : public IVehiclePowertrainTractionBatteryChargingChargingPortRearLeft
{
public:
    explicit VehiclePowertrainTractionBatteryChargingChargingPortRearLeft();
    ~VehiclePowertrainTractionBatteryChargingChargingPortRearLeft();
public:
    /**
...
private:
    /** The publisher for the Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_RearLeft. */
    std::unique_ptr<IVehiclePowertrainTractionBatteryChargingChargingPortRearLeftPublisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_RearLeft. */
    VehiclePowertrainTractionBatteryChargingChargingPortRearLeftData m_data;
};
} // namespace Vehicle
} // namespace Cpp
