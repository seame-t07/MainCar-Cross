...
/**
* The Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_FrontLeft implementation.
*/
class CPP_VEHICLE_EXPORT VehiclePowertrainTractionBatteryChargingChargingPortFrontLeft : public IVehiclePowertrainTractionBatteryChargingChargingPortFrontLeft
{
public:
    explicit VehiclePowertrainTractionBatteryChargingChargingPortFrontLeft();
    ~VehiclePowertrainTractionBatteryChargingChargingPortFrontLeft();
public:
    /**
...
private:
    /** The publisher for the Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_FrontLeft. */
    std::unique_ptr<IVehiclePowertrainTractionBatteryChargingChargingPortFrontLeftPublisher> m_publisher;
    /** The helper structure to store all the properties for Vehicle_Powertrain_TractionBattery_Charging_ChargingPort_FrontLeft. */
    VehiclePowertrainTractionBatteryChargingChargingPortFrontLeftData m_data;
};
} // namespace Vehicle
} // namespace Cpp
